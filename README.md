...
Also, ***do not use AI***, either agentically or to search for solutions. While we think there are good uses of AI, the purpose of this assignment is to assess you, not an AI, or your ability to use AI.
...
An API key will be sent to you to use for this exercise.
